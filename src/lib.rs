...
pub fn process_instruction(
    ...
    msg!("Counter entry pointed shalom!!!!");
...
mod test {
    ...
    fn test_counter(){
        ...
        let account = AccountInfo::new(&key, false, false, &mut lamports, &mut data, &owner, false, Epoch::default());
        ...
        assert_eq!(CounterAccount::try_from_slice(&accounts[0].data.borrow())
        .unwrap().
        counter,20);

        let decrement_value = 12u32;
